...
public class Appointment extends JPanel {
    ...
    public  Appointment() throws Exception {
       ...
       JLabel welcome= new JLabel("Add Appointment ");
       ...
       JButton save=new JButton("Add Appointment");
       ...
       panel1.add(doc,mundi);
        ...
        docto.setFont(new java.awt.Font("Tahoma", 10, 16));
         ...
         dates.setFont(new java.awt.Font("Tahoma", 10, 16));
         mundi.gridy=2;
         mundi.gridx=1;
         panel1.add(dates,mundi);
         JTextField inserdate=new JTextField(8 );
         inserdate.setFont(new java.awt.Font("Tahoma", 10, 16));
          mundi.gridy=2;
         mundi.gridx=2;
         panel1.add(inserdate,mundi);
         JLabel times=new JLabel("Time:" );
         times.setFont(new java.awt.Font("Tahoma", 10, 16));
         mundi.gridy=3;
         mundi.gridx=1;
         panel1.add(times,mundi);
          mundi.gridy=3;
         mundi.gridx=2;
        
         JTextField intimes=new JTextField(8 );
         intimes.setFont(new java.awt.Font("Tahoma", 10, 16));
         
          panel1.add(intimes,mundi);
       ...
       //table creation 
        ...
        modelo.addColumn("Patient_lastname");
       ...
       int rowCounter=0;
        ...
        while(r.next()){
            ...
            String id=r.getString("idapointment");
             ...
             String doctor=r.getString("Username");
             data[3]=doctor;
      ...
      save.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
               ...
               String dat=inserdate.getText().trim();
               String ti=intimes.getText().trim();
               ...
               databaseconection cors=new databaseconection();
                try {
                    ...
                    cors.insertAppointment( dat,ti,valor,idppi);
             ...
             modelo.addRow(data);
             patid.setText(null);
             inserdate.setText(null);
             intimes.setText(null);
            ...
            public void actionPerformed(ActionEvent e) {
              databaseconection cone=new databaseconection();
                ...
                try {
                   ...
                   cone.deleteRecordAppointment("apointment", idp);
...
e.consume();
      ...
      b.gridx=4;
       ...
       hola.add(js);
        ...
        // buttons finished at this point 
